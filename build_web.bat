...
:: Verify call emcc is available
where call emcc >nul 2>&1
if errorlevel 1 (
    echo ERROR: call emcc not found in PATH.
...
call emcc -c %RAYLIB_SRC%/rcore.c     -o build/web/rcore.o     %CFLAGS%
if errorlevel 1 goto error
call emcc -c %RAYLIB_SRC%/rshapes.c   -o build/web/rshapes.o   %CFLAGS%
if errorlevel 1 goto error
call emcc -c %RAYLIB_SRC%/rtextures.c -o build/web/rtextures.o %CFLAGS%
if errorlevel 1 goto error
call emcc -c %RAYLIB_SRC%/rtext.c     -o build/web/rtext.o     %CFLAGS%
if errorlevel 1 goto error
call emcc -c %RAYLIB_SRC%/utils.c     -o build/web/utils.o     %CFLAGS%
if errorlevel 1 goto error
call emcc -c %RAYLIB_SRC%/rmodels.c   -o build/web/rmodels.o   %CFLAGS%
if errorlevel 1 goto error
call emcc -c %RAYLIB_SRC%/raudio.c    -o build/web/raudio.o    %CFLAGS%
if errorlevel 1 goto error

echo [2/3] Compiling project sources...
call emcc -c src/Mesh.cpp     -o build/web/Mesh.o     %CXXFLAGS%
if errorlevel 1 goto error
call emcc -c src/Particle.cpp -o build/web/Particle.o %CXXFLAGS%
if errorlevel 1 goto error
call emcc -c src/Spring.cpp   -o build/web/Spring.o   %CXXFLAGS%
if errorlevel 1 goto error
call emcc -c src/main.cpp     -o build/web/main.o     %CXXFLAGS%
if errorlevel 1 goto error
